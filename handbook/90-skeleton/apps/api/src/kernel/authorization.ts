...
/**
 * What authorize() returns instead of silently consuming quota.
 * If quotaKey is present, the use case MUST reserve it inside the same
 * transaction as its write, then commit or release.
 */
